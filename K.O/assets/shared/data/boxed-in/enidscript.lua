...
name_of_character_xml = 'enid-stand'
name_of_character = 'enid-stand'
name_of_notetype = 'Enid Notes'
...
function onCreate()
	...
	addAnimationByIndices(name_of_character, 'idle', idle_xml_name, '0,1,2,3,3,4,4,5,5,6', 24)
	addAnimationByIndices(name_of_character, 'singRIGHT', left_xml_name, '0,0,1,2,3,4,5', 16)
	addAnimationByIndices(name_of_character, 'singDOWN', down_xml_name, '0,0,1,2,3,4,5', 16)
	addAnimationByIndices(name_of_character, 'singUP', up_xml_name, '0,0,1,2,3,4,5', 16)
	addAnimationByIndices(name_of_character, 'singLEFT', right_xml_name, '0,0,1,2,3,4,5', 16)
