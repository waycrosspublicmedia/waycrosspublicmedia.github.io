...
local xx = 970; -- Code to change the position of the camera to the left or right for your opponent, Less = Left (They can be negative numbers), More = Right
...
local yy2 = -200; -- Same code as above, but for boyfriend up, down
local xx3 = 1400; -- Same code as above, but for girlfriend left, right
