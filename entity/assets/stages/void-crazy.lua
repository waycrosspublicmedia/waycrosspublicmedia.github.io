...
function onCreate()
	...
	makeAnimatedLuaSprite('fakeGf', 'entity/agoti/GF_rock', 700, -440);
	addAnimationByPrefix('fakeGf', 'idle', 'GF Dancing Beat Hair blowing');
	setScrollFactor('fakeGf', 0.85, 0.85);

	makeAnimatedLuaSprite('box', 'entity/agoti/LoudSpeaker_Moving', -400, 560);
