...
function onCreate()
	makeAnimatedLuaSprite('Dad2', 'characters/light(normal)', -600, -650); -- Change to characters idle in XML
	addAnimationByPrefix('Dad2', 'idle', 'GF Dancing Beat', 24, false); -- Change to characters idle in XML
