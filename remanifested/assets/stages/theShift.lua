...
function onCreate()
    if songName == 'Wife-Forever' then
        makeLuaSprite("shift", "backgrounds/skyweek/wife4ever/bg", -388.05 - 130, -202);
        addLuaSprite("shift", false);
        makeLuaSprite("shift2", "backgrounds/skyweek/wife4ever/bg1", -388.05 - 130, -202);
        addLuaSprite("shift2", false);
        setProperty('shift2.alpha', 0);
    else
        folder = 'backgrounds/skyweek/sky/'
        makeLuaSprite("shift", "backgrounds/skyweek/sky/bg", -388.05 - 130, -202);
        addLuaSprite("shift", false);
        makeLuaSprite("shiftblue", "backgrounds/skyweek/bgblue", -388.05 - 130, -202);
        addLuaSprite("shiftblue", false);
        setProperty('shiftblue.alpha', 0)
        makeLuaSprite("shiftgreen", "backgrounds/skyweek/bggreen", -388.05 - 130, -202);
        addLuaSprite("shiftgreen", false);
        setProperty('shiftgreen.alpha', 0)
        makeLuaSprite("shiftred", "backgrounds/skyweek/bgred", -388.05 - 130, -202);
        addLuaSprite("shiftred", false);
        setProperty('shiftred.alpha', 0)
        makeLuaSprite("shiftpink", "backgrounds/skyweek/bgpink", -388.05 - 130, -202);
