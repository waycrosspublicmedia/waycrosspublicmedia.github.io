...
makeLuaText('songby', 'Song: Crossknife, Kreagato, Cloverderus', 0, 0, 0)
...
makeLuaText('chartby', 'Chart: Kloogybaboogy', 0, 0, 0)
...
if t == 'byeCred' then
doTweenX('ByeCredits', 'box', -500, 0.5, 'sineInOut')
end
end