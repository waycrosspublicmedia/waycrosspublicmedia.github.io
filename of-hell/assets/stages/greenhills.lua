function onCreate()
	...
	scaleObject('water', 2.0, 2.0);
        ...
        makeAnimatedLuaSprite('flowers', 'flowers', 300,500)
        addAnimationByPrefix('flowers', 'a', 'lall', 24, true)
	objectPlayAnimation('flowers', 'a', true)
	scaleObject('flowers', 1.7, 1.7);
        setScrollFactor('flowers', 1.0, 1.0);
